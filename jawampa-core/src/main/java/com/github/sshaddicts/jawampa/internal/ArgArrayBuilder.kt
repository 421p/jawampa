 ...
 */
object ArgArrayBuilder {
    /**
     * Builds an ArrayNode from all positional arguments in a WAMP message.<br></br>
     ...
     */
    fun buildArgumentsArray(objectMapper: ObjectMapper, vararg args: Any): ArrayNode? {
        if (args.size == 0) return null
        // Build the arguments array and serialize the arguments
        val argArray = objectMapper.createArrayNode()
        for (arg in args) {

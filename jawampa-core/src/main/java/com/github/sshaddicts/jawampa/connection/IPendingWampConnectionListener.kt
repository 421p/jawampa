...
/**
 * A listener interface for a connection that is currently established.<br></br>
 * Once the connection is established one of the callback methods that this
 * listener provides will be called.
 */
interface IPendingWampConnectionListener {
    /** The connection succeeded  */
    fun connectSucceeded(connection: IWampConnection)

    /**
     * The connection of the transport failed or the connection was cancelled.
     */
    fun connectFailed(cause: Throwable)
}

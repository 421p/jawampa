...
interface IWampConnection {
     ...
     * and [IWampConnection.sendMessage]
     * and [IWampConnection.sendMessageAndClose]
     * can be called arbitrarily often.
     * @return true if only one message can be sent at once, false otherwise
     */
    val isSingleWriteOnly: Boolean

    /**
     * Send a message through the connection.<br></br>
     * This may not throw.
     *
     ...
     */
    fun sendMessage(message: WampMessage, promise: IWampConnectionPromise<Void>)

    /**
     * Close the connection independent of it's current state.<br></br>
     * This method must be callable even when a message is currently transmitted.<br></br>
     * <br></br>
     ...
     * events will be sent to the configured [IWampConnectionListener].<br></br>
     * <br></br>
     * This may not throw.
     *
     ...
     * closed.
     */
    fun close(sendRemaining: Boolean, promise: IWampConnectionPromise<Void>)
}
